...
(function() {
  ...
  module.exports = function(value) {
    ...
    // (checking for 3+ consecutive roman nums will be done while iterating the string in toInt)
      ...
      // chack that only valid characters are passed
   ...
   * @returns {Int}
   * 
   * If convert parameter is passed, function will convert a RN to a number/integer.
   ...
   * @returns {string}
   * 
   * If convert parameter is passed, function will convert an integer to a RN.
   * If no convert, then value passed will simply be returned.
   *
   * Traverses a lookup table of decreasing RN values and adds to return value 
